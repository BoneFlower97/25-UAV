                         ...
                         bool iqInverted, bool rxContinuous )
{
    //uint8_t syncWordBuf[]={ 0xC1, 0x94, 0xC1, 0x00, 0x00, 0x00, 0x00, 0x00 };
		uint8_t syncWordBuf[] = { 0x2D, 0x01, 0x2D, 0x01 };
    ...
    switch( modem )
    {
        case MODEM_FSK:
            ...
            SX126x.ModulationParams.Params.Gfsk.Bandwidth = RadioGetFskBandwidthRegValue( bandwidth ); // SX126x badwidth is double sided
                              ...
                              bool crcOn )
{
    ...
    const uint8_t syncWordLength = 4;
